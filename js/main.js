...
class Viewer {
    constructor (basePath) {
        ...
        this.l2d.load("Azue Lane(JP)/biaoqiang", this);
        this.canvas = $(".Canvas");
        this.selectCharacter = $(".selectCharacter");
        this.selectAnimation = $(".selectAnimation");

        this.app = new PIXI.Application(1280, 720, { backgroundColor: 0x999999});
        ...
        window.onresize = (event) => {
            ...
            if (this.model) {
                this.model.position = new PIXI.Point((width * 0.5), (height * 0.6));
